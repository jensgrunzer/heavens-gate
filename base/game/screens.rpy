...
screen phone_message_image(who, what, img):
    vbox at incoming_message:
        style_group "phone_message"
        add img at phone_message_avatar
        # this one adds the triangular tip for the bubble, if you change colors you change this images too
        add "images/bubble-tip.png" at phone_message_bubble_tip
...
screen navigation():
    ...
    vbox:
        ...
        if main_menu:
            ...
            textbutton _("Diary") action Start("diary")
...
screen about():
    ...
    use game_menu(_("About"), scroll="viewport"):
        ...
        vbox:
            ...
            text _("Heaven's Gate is a short Hello Charlotte spin-off coming-of-age kinetic novel developed by etherane.\n\nThis VN is available for free in English at {a=https://etherane.itch.io/hg}itch.io{/a}. Any reprint or illegal distribution of this work is prohibited. \n\nMade with {a=https://www.renpy.org/}Ren'Py{/a} [renpy.version_only].\n\n[renpy.license!t]")
