...
transform phone_message_avatar:
    xoffset -100
    yoffset 96
...
define config.name = _("Heaven's Gate")
...
define config.save_directory = "HeavensGate-1528999663"
